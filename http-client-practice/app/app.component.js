System.register(['angular2/core', './app.service', 'angular2/http'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, app_service_1, http_1;
    var AppComponent;
    return {
        setters:[
            function (core_1_1) {
        ...
        execute: function() {
            AppComponent = (function () {
                function AppComponent(_appService) {
                    ...
                    this.title = 'Fetching data example';
                }
                AppComponent.prototype.ngOnInit = function () { this.getPost(); };
